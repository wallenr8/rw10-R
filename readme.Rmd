...
ℑ𝔰𝔰𝔲𝔢𝔰:
I hads issues with  the values, coming out as negative values, i had to use absolute value for outputs. entries are manually inputted.
